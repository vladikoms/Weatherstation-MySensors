...
#define MY_RFM95_FREQUENCY   432200000                      // Рабочая частота: 432.2 МГц
...
{ 
 ...
 for (x=0;x<360; x++)                          // Цикл записи данных о скорости ветра в массив
{    
  wind = getWind();                            // Запись значений скорости ветра в каждый элемент массива
